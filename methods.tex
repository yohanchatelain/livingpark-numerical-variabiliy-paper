...
For QC, we visually inspected nine
...
segmentation. Table~\ref{tab:qc} \TG{table reference is broken} details the exclusion rates. To ensure
...
\TG{I think you need to explain how you computed the probability of false positives in section 2.3}

\subsection{Probability of false positives due to numerical uncertainty}
