...
biologically implausible segmentation. Supplementary Table~\ref{tab:qc} details the
...
Proofs of partial derivations of sample statistics\footnote{mean, variance, standard-deviation, covariance, Pearson correlation coefficient and correlation identities.} used in the following sections are provided in the Supplementary Note~\ref{appendix:partial_derivatives_proofs}.
...
(see Supplementary Eq.~\ref{eq:pearson_derivative})
\[
...
(see Supplementary Eq.~\ref{eq:correlation_identities}), and that
...
Note~\ref{appendix:numerical_validation_flip_significance}.
