...
\TG{Remove appendices that are not referred in the text, for instance significant digits formula, dice coefficient, etc}
...
\ref{fig:consistency_area_coefficients} and \ref{fig:consistency_volume_coefficients} show the
distribution of partial correlation coefficients and F-statistics for
subcortical volume measures, cortical thickness, cortical areas and cortical
volumes, across all subjects and regions. Red triangles indicate the unperturbed
(IEEE-754) run for reference. For all analyses, the unperturbed (IEEE-754)
result is included in the range of numericallly perturbed results, which
supports the validity of the numerical perturbation. \TG{Yohan, please check my edits to this paragraph}
