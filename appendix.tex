...
systematically compared analytical standard-deviation estimates derived from the
...
perturbations of the full processing pipelines. For each statistical endpoint
...
metrics, and for both cross-sectional and longitudinal study designs, thereby
assessing the fidelity of the analytical model under heterogeneous numerical and
...
more strongly to the negative tail. Cohen's $d$ consistently exhibits the most
compact and symmetric distributions among the tested statistics.
...
cross-sectional analyses, mean relative errors were 0.054 ($\pm$0.301) for the
two-sample $t$-test, 0.106 ($\pm$0.323) for ANCOVA, and 0.043 ($\pm$0.322) for
...
mean relative errors of -0.251 ($\pm$0.374) for the $t$-test,
-0.117 ($\pm$0.426) for ANCOVA, and -0.233 ($\pm$0.310) for partial
...
stability. The longitudinal negative bias reflects a conservative tendency of
the analytical model to overestimate variability.
