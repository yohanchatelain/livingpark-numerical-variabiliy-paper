...
\title{Computational uncertainty in neuroimaging mimics and masks brain disease signals}
...
\begin{abstract}
    ...
    impact of numerical variability in a ubiquitous neuroimaging tool,
...
scientific conclusions become inherently fragile. This may contribute to the
...
\begin{figure}
    ...
    \caption{ Proportion of statistically significant tests ($p < 0.05$) across
        the 26 numerical states for subcortical volume
...
\begin{figure}
    ...
    \caption{Proportion of statistically significant tests ($p < 0.05$) across
        the 26 numerical states for cortical thickness
...
findings are shown to be potentially unreliable. This analysis demonstrates that
...
the robustness of scientific results is a shared responsibility. Software
