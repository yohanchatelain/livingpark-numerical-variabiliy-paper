...
27\% of the (regions, analysis) pairs \TG[done]{of the regions or of the (region, analysis) pairs?},
...
(regions, analysis) pairs \TG[done]{same comments} were similarly found to be unstable. These
...
\begin{figure}
    ...
    \caption{ Proportion of significant tests ($p<0.05$) for subcortical volumes
        across 26 numerical perturbations measures.\label{fig:significance_correlation_subcortical_volume}}
\end{figure}
...
across cortical and subcortical regions was 0.191 in the PD group and 0.176 in
the HC group. No significant differences in mean \navr were observed between HC
and PD groups (Permutation test with 10,000 resamples; $\alpha=0.05$ with
Bonferroni correction), supporting the idea that numerical variability measured
through \navr may roughly generalize across populations, for structural MRI
measures produced by FreeSurfer. The Cohen's d formula in
Table~\ref{tab:stat_uncertainty} gives that for this level of uncertainty,
achieving a negligible level of numerical uncertainty ($\sigma_d \leq 0.01$)
would require 1340 participants. Longitudinal analyses exhibited substantially
higher \navr values, 0.561 for PD and 0.549 for HC, likely owing to the
occurrence of catastrophic cancellation when substracting nearly equal numbers
between timepoints. Using the same formula, we anticiapte that at this level of
uncertainty, achieving a negligible numerical uncertainty ($\sigma_d \leq 0.01$)
would require at least 12,321 participants.
