...
\begin{figure}
    ...
    \caption{Probability of numerically-induced false positives across different
        statistics: T-values (T), F-values (F), and correlation coefficients (R).}
...
Tools~\cite{avants2009advanced} (ANTs), \TG[done]{add references to FSL, ANTs
    and SPM, and expand acronyms} while suggesting lower sensitivity in Statistical
Parametric Mapping~\cite{ashburner2009computational} (SPM), potentially due to
differences in optimization strategies and regularization. These findings
