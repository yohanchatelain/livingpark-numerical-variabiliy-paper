...
\TG{The remainder of
    this paragraph is quite informal, could you tidy up the equations to start from
    the definition of Cohen's d and clearly derive its standard deviation? You should also clarify the assumptions that are made.}
...
\end{equation}
which is the regime relevant to well-conditioned pipelines.
...
$S_p^2=\big((n_1-1)S_1^2+(n_2-1)S_2^2\big)/(n_1+n_2-2)$ and $\nu:=n_1+n_2-2$.
...
$1/\nu$) to the variance of $d$ across numerical re-runs is
\begin{equation}
    ...
    \;+\;
    \underbrace{\frac{\delta^2}{2\,\nu}\left(\frac{\sigma_{\text{num}}^2}{\sigma_{\text{tot}}^2}\right)^{\!2}}_{\text{denominator term}},
    \qquad
    \sigma_{\text{tot}}^2:=\sigma_{\text{anat}}^2+\sigma_{\text{num}}^2,\;\;
