...
(Figure~\ref{fig:navr}). In cross-sectional baseline analyses \TG[done]{in figure 3,
    change "baseline" to "cross-sectional"}, the average \navr was 0.191 for the PD
group and 0.176 for HC, with no significant difference between groups
(permutation test, $p > 0.05$; Appendix Figure~\ref{tab:bootstrap-navr}).
Applying the Cohen's $d$ uncertainty formula (Table~\ref{tab:stat_uncertainty})
to these \navr values reveals that suppressing numerical uncertainty to a
...
Appendix Figure~\ref{tab:bootstrap-navr}). \TG[done]{was there significant differences
    between groups? report test as in the previous paragraph}. This amplification is
...
(Table~\ref{tab:stat_uncertainty}) to re-evaluate findings from ten articles
