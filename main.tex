...
is highly compute-intensive and impractical to perform routinely. We developed a practical analytical model of numerical variability in
MRI analyses, assuming that this variability is an inherent property of the
computational pipeline and generalizes across
populations. To do so, we derived closed-form approximations of numerical
