...
Verificarlo~\cite{denis2016verificarlo}. This LLVM-based compiler replaces
...
\begin{figure}
    ...
    \caption{Ratio of statistical tests that were significant
        ($p<0.05$) among the 26 MCA repetitions for each regions.}
\end{figure}
...
\begin{figure}
    ...
    \caption{r-values and F-values distribution for the significant tests among the 26 MCA repetitions.
        Top row: r-values distribution. Bottom row: F-values distribution. Left column: Baseline analysis. Right column: Longitudinal analysis.}
\end{figure}
...
sizes of significant regions varied considerably, with examples such as 1005.95
± 39.34 mm² and 996.83 ± 42.91 mm².
