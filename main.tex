...
\begin{figure}
    ...
    \caption{ Proportion of significant tests ($p<0.05$) for subcortical volumes
        across 26 numerical perturbations measures \TG[done]{could you sort the
        x-axis by region first rather than by
        hemisphere?}.\label{fig:significance_correlation_subcortical_volume}
        \TG[done]{Make sure that ``right accumbens area'' also appears in the x
        labels}}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{figures/NAVR_map/figure_3.pdf}
