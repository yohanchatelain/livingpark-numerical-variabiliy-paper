...
\begin{abstract}
    ...
    assess the impact of numerical noise in existing studies. By applying this
    ...
    disease. These results underscore the importance of systematically
    evaluating numerical stability in neuroimaging.
\end{abstract}
